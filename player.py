...
class Player(pygame.sprite.Sprite):
    ...
    def move(self,level):
        ...
        u1, u2, l1, l2, d1, d2, r1, r2=level.check_collision(n1,n2-1), level.check_collision(n1+self.w,n2-1), level.check_collision(n1-1,n2), level.check_collision(n1-1,n2+self.h), level.check_collision(n1,n2+self.h+1), level.check_collision(n1+self.w,n2+1+self.h), level.check_collision(n1+self.w+1,n2), level.check_collision(n1+self.w+1,n2+self.h)
